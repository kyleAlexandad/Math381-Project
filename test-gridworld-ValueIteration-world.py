...
problem = GridWorld('data/sunset_heatmap.csv', reward={0: -0.04, 1: 50.0, 2: -50.0, 3: np.NaN, 4:-0.1}, random_rate=0.2)
#problem = GridWorld('data/defender_sunset.csv', reward={0: -0.04, 1: 5.0, 2: -5.0, 3: np.NaN, 4:-2.5}, random_rate=0.2)
